...
export default function DooliDetailsPage() {
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 pt-32 relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              Dooli - <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Success Story</span>
            </motion.h1>
            ...
            >
              ...
              <div className="w-full h-full rounded-[38px] overflow-hidden bg-gradient-to-br from-blue-900 via-indigo-950 to-slate-950 relative border border-slate-900 flex flex-col justify-between p-6">
                ...
                <div className="flex justify-between items-center mt-4">
                  <span className="font-extrabold text-[15px] text-white tracking-tight">Dooli</span>
                ...
                <div className="my-auto space-y-4">
                  ...
                  <div className="text-center space-y-1">
                    <p className="text-white text-lg font-black tracking-tight">Seamless Ride</p>
                    <p className="text-slate-400 text-[10px] uppercase font-bold tracking-widest">Cab • Parcel • JCB</p>
                  </div>
                </div>
                ...
                <div className="h-28 rounded-2xl bg-white/5 border border-white/5 relative overflow-hidden backdrop-blur-md flex flex-col justify-end p-3 text-left">
                  ...
                  <div className="relative z-10">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide">Destination reached</p>
                    <p className="text-white text-xs font-black mt-0.5">Booking Completed</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              { label: "Estimated Time", val: "60 Days", icon: <Clock className="w-5 h-5 text-amber-500" />, bg: "bg-amber-50 border-amber-100/60" },
              { label: "Bugs Fixing", val: "769 +", icon: <Bug className="w-5 h-5 text-rose-500" />, bg: "bg-rose-50 border-rose-100/60" },
              { label: "Security Standards", val: "99.99%", icon: <ShieldCheck className="w-5 h-5 text-emerald-500" />, bg: "bg-emerald-50 border-emerald-100/60" },
              { label: "Project Completion", val: "67 Days", icon: <CheckCircle2 className="w-5 h-5 text-indigo-500" />, bg: "bg-indigo-50 border-indigo-100/60" },
              { label: "Traffic Spikes Handled", val: "250%", icon: <TrendingUp className="w-5 h-5 text-blue-500" />, bg: "bg-blue-50 border-blue-100/60" }
            ].map((stat, i) => (
              <motion.div
                key={i}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-24 items-start">
          ...
          <div className="lg:col-span-6 text-left space-y-6">
            ...
            <div className="space-y-6">
              {[
                { title: "Strategized Structure", desc: "Strategized the app structure to effectively showcase the brand’s stunning vision" },
                { title: "Intuitive UI/UX Design", desc: "Designed an intuitive, visually appealing, and user-friendly interface for seamless navigation" },
                { title: "Feature Alignment", desc: "Implemented the planned design and features, ensuring alignment" },
                { title: "Full Content Integration", desc: "Built a fully functional app, integrating content, visuals, and technology to enhance user engagement" }
              ].map((dev, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 15 }}
                ...
                >
                  ...
                  <div>
                    <h4 className="font-extrabold text-[15px] text-slate-900">{dev.title}</h4>
                    <p className="text-slate-500 text-xs sm:text-sm font-semibold mt-1 leading-relaxed">{dev.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
