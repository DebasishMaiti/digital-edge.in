...
import { CheckCircle2, Terminal, Search, FileText, Share2, Sparkles, TrendingUp, ArrowRight } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#fafbfc] min-h-screen pb-24 text-slate-800">
        ...
        <section className="relative z-10 w-full py-24 sm:py-32 bg-gradient-to-b from-white via-slate-50/50 to-white overflow-hidden border-b border-slate-100">
          {/* Ambient Glows */}
          ...
          <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            ...
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-[#0d1b3e] tracking-tight">
                SEO Performance Showcase
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-slate-500 font-semibold leading-relaxed max-w-2xl mx-auto">
                Explore real analytics and ranking breakthroughs achieved through our data-driven technical SEO, content optimization, and search authority strategies.
              </p>
              <div className="w-20 h-1 bg-gradient-to-r from-blue-500 to-indigo-600 mx-auto rounded-full mt-4" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white rounded-[28px] overflow-hidden border border-slate-200/80 shadow-[0_10px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(36,67,171,0.08)] transition-all duration-300 flex flex-col justify-between group"
                >
                  {/* Image Container matching exact 731x278 aspect ratio */}
                  <div className="relative aspect-[731/278] w-full overflow-hidden bg-slate-900 border-b border-slate-100 flex items-center justify-center">
                    <Image
                      src={item.src}
                      alt={item.title}
                      fill
                  ...
                  {/* Card Info */}
                  <div className="p-6 sm:p-7 flex flex-col justify-between flex-grow bg-white space-y-3">
                    <h3 className="text-xl sm:text-2xl font-black text-[#0d1b3e] tracking-tight group-hover:text-blue-600 transition-colors duration-300">
                      {item.title}
                    </h3>
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left p-5 rounded-2xl border transition-all duration-300 ${isActive
                      ...
                      >
                        <h4 className={`text-lg font-black tracking-tight mb-2 transition-colors duration-300 ${isActive ? "text-slate-900" : "text-slate-400 hover:text-slate-600"
                          }`}>
                          {tab.title}
                        </h4>
                        <p className={`text-xs sm:text-sm font-semibold leading-relaxed transition-colors duration-300 ${isActive ? "text-slate-600" : "text-slate-400"
                          }`}>
                          {tab.desc}
                        </p>
                      </button>
